...
if [ -z "${CLOUDFLARE_API_TOKEN:-}" ]; then
  echo
  echo "[JARVIS V0.6.1] Cloudflare API Token required"
...
echo "[JARVIS V0.6.1] Deploying Worker with API token authentication..."
npx wrangler deploy

echo
 echo "[JARVIS V0.6.1] Worker deployment complete."
